...
export class LandingDecoradoresComponent implements OnInit {
  ...
  constructor(private _route: ActivatedRoute, private _router: Router,private meta: Meta,private title1: Title) {
    ...
    this.meta.updateTag({ name: 'image', content: 'http://blog.matisses.co:4000/assets/images/decoradores.jpg' });
    this.meta.addTag({ property: 'og:url', content: 'http://blog.matisses.co/decoradores' });
    this.meta.addTag({ property: 'og:title', content: 'Decoradores-Matisses' });
    this.meta.addTag({ property: 'og:image', content: 'http://blog.matisses.co:4000/assets/images/decoradores.jpg' });
